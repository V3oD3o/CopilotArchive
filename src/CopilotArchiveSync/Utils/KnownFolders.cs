...
public static class KnownFolders
{
   ...
   {
      public static readonly Guid AddNewPrograms = new("de61d971-5ebc-4f02-a3a9-6c82895e5c04");
      public static readonly Guid AdminTools = new("724EF170-A42D-4FEF-9F26-B60E846FBA4F");
      public static readonly Guid AppUpdates = new("a305ce99-f527-492b-8b1a-7e76fa98d6e4");
      public static readonly Guid CDBurning = new("9E52AB10-F80D-49DF-ACB8-4330F5687855");
      public static readonly Guid ChangeRemovePrograms = new("df7266ac-9274-4867-8d55-3bd661de872d");
      ...
      public static readonly Guid ConflictFolder = new("4bfefb45-347d-4006-a5be-ac0cb0567192");
      ...
      public static readonly Guid Games = new("CAC52C1A-B53D-4edc-92D7-6B2E8AC19434");
      public static readonly Guid GameTasks = new("054FAE61-4DD8-4787-80B6-090220C4B700");
      ...
      public static readonly Guid OriginalImages = new("2C36C0AA-5812-4b87-BFD0-4CD0DFB19B39");
      public static readonly Guid PhotoAlbums = new("69D2CF90-FC33-4FB7-9A0C-EBB0F0FCB43C");
      public static readonly Guid Pictures = new("33E28130-4E1E-4676-835A-98395C3BC3BB");
      public static readonly Guid Playlists = new("DE92C1C7-837F-4F69-A3BB-86E631204A23");
      ...
      public static readonly Guid ProgramFilesX64 = new("6D809377-6AF0-444b-8957-A3773F02200E");
      ...
      public static readonly Guid ProgramFilesCommonX64 = new("6365D5A7-0F0D-45E5-87F6-0DA56B6A4F7D");
      ...
      public static readonly Guid PublicGameTasks = new("DEBF2536-E1A8-4c59-B6A2-414586476AEA");
      ...
      public static readonly Guid SampleMusic = new("B250C668-F57D-4EE1-A63C-290EE7D1AA1F");
      public static readonly Guid SamplePictures = new("C4900540-2379-4C75-844B-64E6FAF8716B");
      public static readonly Guid SamplePlaylists = new("15CA69B3-30EE-49C1-ACE1-6B5EC372AFB5");
      public static readonly Guid SampleVideos = new("859EAD94-2E85-48AD-A71A-0969CB56A6CD");
      public static readonly Guid SavedGames = new("4C5C32FF-BB9D-43b0-B5B4-2D72E54EAAA4");
      public static readonly Guid SavedSearches = new("7d1d3a04-debb-4115-95cf-2f29da2920da");
      public static readonly Guid SEARCH_CSC = new("ee32e446-31ca-4aba-814f-a5ebd2fd6d5e");
      public static readonly Guid SEARCH_MAPI = new("98ec0e18-2098-4d44-8644-66979315a281");
      public static readonly Guid SearchHome = new("190337d1-b8ca-4121-a639-6d472d16972a");
      public static readonly Guid SendTo = new("8983036C-27C0-404B-8F08-102D10DCFD74");
      public static readonly Guid SidebarDefaultParts = new("7B396E54-9EC5-4300-BE0A-2482EBAE1A26");
      public static readonly Guid SidebarParts = new("A75D362E-50FC-4fb7-AC2C-A8BEAA314493");
      ...
      public static readonly Guid SyncManagerFolder = new("43668BF8-C14E-49B2-97C9-747784D784B7");
      public static readonly Guid SyncResultsFolder = new("289a9a43-be44-4057-a41b-587a76d7e7f9");
      public static readonly Guid SyncSetupFolder = new("0F214138-B1D3-4a90-BBA9-27CBC0C5389A");
      ...
      public static readonly Guid TreeProperties = new("5b3749ad-b49f-49c1-83eb-15370fbd4882");
      public static readonly Guid UserProfiles = new("0762D272-C50A-4BB0-A382-697DCD729B80");
      public static readonly Guid UsersFiles = new("f3ce0f7c-4901-4acc-8648-d5d44b04ef8f");
   ...
   public static string GetKnownFolderPath(Guid guid)
   {
      ...
      try
      {
         int hr = NativeMethods.SHGetKnownFolderPath(guid, NativeMethods.KF_FLAG_DEFAULT, IntPtr.Zero, out rawPath);

         // If the folder is not configured, Windows returns a failure HRESULT. 
         // To avoid unnecesary exceptions, instead of throwing, we return null
         if (hr != 0 || rawPath == IntPtr.Zero)
            return null;

         string path = Marshal.PtrToStringUni(rawPath);

         // Empty or whitespace also counts as "not configured"
