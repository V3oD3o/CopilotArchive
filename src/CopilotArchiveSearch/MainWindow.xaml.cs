using CopilotArchiveSearch.Chunked;
using CopilotArchiveSearch.Markdown;
using CopilotArchiveSearch.Search;
using CopilotArchiveSearch.Utils;
...
using SearchResult = CopilotArchiveSearch.Search.SearchResult;
using Timer = System.Timers.Timer;

namespace CopilotArchiveSearch
{
